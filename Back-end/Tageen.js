fetch('./../../Data-base/Tageen.json')
  ...
  .then(data => {
    ...
    document.getElementById('Tageen_type_2_1').textContent = data.Tageen_type_2_1;
    document.getElementById('Tageen_prise_2_1').textContent = data.Tageen_prise_2_1;
    ...
    document.getElementById('Tageen_type_3_1').textContent = data.Tageen_type_3_1;
    document.getElementById('Tageen_prise_3_1').textContent = data.Tageen_prise_3_1;
    ...
    document.getElementById('Tageen_type_4_1').textContent = data.Tageen_type_4_1;
    document.getElementById('Tageen_prise_4_1').textContent = data.Tageen_prise_4_1;
    ...
    document.getElementById('Tageen_type_5_1').textContent = data.Tageen_type_5_1;
    document.getElementById('Tageen_prise_5_1').textContent = data.Tageen_prise_5_1;
